    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-header with-border">
                ...
                <button onclick="addForm('{{ route('databarang3.store') }}')" class="btn btn-success btn-xs btn-flat"><i class="fa fa-plus-circle"></i> Tambah</button>
                <button onclick="deleteSelected('{{ route('databarang3.delete_selected') }}')" class="btn btn-danger btn-xs btn-flat"><i class="fa fa-trash"></i> Hapus</button>
                <button onclick="cetakBarcode('{{ route('databarang3.cetak_barcode') }}')" class="btn btn-info btn-xs btn-flat"><i class="fa fa-barcode"></i> Cetak Barcode</button>
                <button onclick="cetakLaporan('{{ route('databarang3.cetak_laporan') }}')" class="btn btn-success btn-xs btn-flat"><i class="fa fa-file-excel-o"></i> Cetak Laporan</button>    
                @endif
            </div>
            </div>
...
@includeIf('databarang3.form')
@includeIf('databarang3.mutasi')
@endsection
