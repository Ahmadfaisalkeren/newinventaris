        ...
        <form action="" method="post" class="form-horizontal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="level" class="col-lg-3 col-lg-offset-1 control-label">Tempat</label>
                        <div class="col-lg-6">
                        <select name="level" class="form-control" id="level" required>
                            <option value="2">Laboratorium Hardware</option>
                            <option value="3">Laboratorium Multimedia</option>
                            <option value="4">Laboratorium Software</option>
                        </select>
                        </div>
                    </div>
                    <div class="form-group row">
