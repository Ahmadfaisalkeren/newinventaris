        ...
        <div class="box">
            ...
            <div class="box-body">
                    ...
                    <div class="form-group row">
                        <label for="tanggal_kembali" class="col-lg-2 control-label">Tanggal Kembali</label>
                        <div class="col-lg-4">
                        <input type="text" id="tanggal_kembali" name="tanggal_kembali" class="form-control datepicker"
                ...
                <div class="row">
                    <div class="col-lg-10">
                        <form action="{{ route('peminjaman.store') }}" class="form-peminjaman" method="post">
                            ...
                            <input type="hidden" name="id_laboratorium" id="id_laboratorium" value=1>
                            <div class="form-group row">
...
@includeIf('peminjaman_detail.databarang')
@endsection
...
<script>
    ...
    $(function () {
        table = $('.table-peminjaman').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: '{{ route('peminjaman_detail.data',$id_peminjaman) }}',
            },
            columns: [
    ...
    function tambahBarang(){
        $.post('{{route('peminjaman_detail.store')}}',$('.form-barang').serialize())
        .done(response=>{
            $('#kode_barang').focus();
            table.ajax.reload();
        })
