    ...
    <div class="col-lg-12">
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-lg-10">
                        <form action="{{ route('peminjaman3.store') }}" class="form-peminjaman" method="post">
                            @csrf
...
@includeIf('peminjaman_detail3.databarang')
@endsection
...
<script>
    ...
    $(function () {
        table = $('.table-peminjaman').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: '{{ route('peminjaman_detail3.data',$id_peminjaman) }}',
            },
            columns: [
    ...
    function tambahBarang(){
        $.post('{{route('peminjaman_detail3.store')}}',$('.form-barang').serialize())
        .done(response=>{
            $('#kode_barang').focus();
            table.ajax.reload();
        })
