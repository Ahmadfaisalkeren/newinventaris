    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-header with-border">
                ...
                <button onclick="addForm('{{ route('databarang.store') }}')" class="btn btn-success btn-xs btn-flat"><i class="fa fa-plus-circle"></i> Tambah</button>
                <button onclick="deleteSelected('{{ route('databarang.delete_selected') }}')" class="btn btn-danger btn-xs btn-flat"><i class="fa fa-trash"></i> Hapus</button>
                <button onclick="cetakBarcode('{{ route('databarang.cetak_barcode') }}')" class="btn btn-info btn-xs btn-flat"><i class="fa fa-barcode"></i> Cetak Barcode</button>
                <button onclick="cetakLaporan('{{ route('databarang.cetak_laporan') }}')" class="btn btn-success btn-xs btn-flat"><i class="fa fa-file-excel-o"></i> Cetak Laporan</button>  
                @endif
            </div>
            </div>
...
@includeIf('databarang.form')
@includeIf('databarang.mutasi')
@endsection
    ...
    function editForm(url) {
        ...
        $.get(url)
            .done((response) => {
                ...
                $('#modal-form [name=tempat]').val(response.tempat);
