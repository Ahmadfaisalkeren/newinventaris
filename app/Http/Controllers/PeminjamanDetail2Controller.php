...
class PeminjamanDetail2Controller extends Controller
{
    public function index()
    {
        ...
        return view('peminjaman_detail2.index', compact('id_peminjaman','databarang','member'));
    }
