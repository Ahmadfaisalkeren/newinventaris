...
class Databarang3Controller extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('databarang3.index', compact('laboratorium','kategori','user'));
    }
    ...
    public function data()
    {
        ...
        return datatables()
            ...
            ->addColumn('aksi', function ($databarang) {
                ...
                return '
                <div class="btn-group">
                    <button type="button" onclick="editForm(`'. route('databarang3.update', $databarang->id_barang) .'`)" class="btn btn-xs btn-info btn-flat"><i class="fa fa-pencil"></i></button>
                    <button type="button" onclick="deleteData(`'. route('databarang3.destroy', $databarang->id_barang) .'`)" class="btn btn-xs btn-danger btn-flat"><i class="fa fa-trash"></i></button>
                    <button type="button" onclick="formEdit(`'. route('databarang3.edit', $databarang->id_barang) .'`)" class="btn btn-xs btn-warning btn-flat"><i class="fa fa-arrows"></i>Mutasi</button>
                </div>
                ';
            }})
    ...
    public function store(Request $request)
    {
        ...
        $request['kode_barang'] = 'SFW'. tambah_nol_didepan((int)$databarang->id_barang +1, 6);
        $request['id']=auth()->id();
    ...
    public function cetakLaporan(Request $request)
    {
        ...
        ->where('nama_laboratorium','=','Laboratorium Software')
        ->orderBy('kode_barang', 'asc')
        ->get();

        $no  = 1;
        $pdf = PDF::loadView('databarang3.laporan', compact('databarang','no'));
